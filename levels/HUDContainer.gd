...
onready var depth = $BottomHUDContainer/DepthLabel
...
func _ready():
	...
	SignalBus.connect("depth_changed",self,"_on_BlueRov_depth_changed")
...
func _on_BlueRov_depth_changed(new_depth):
	depth.text = "Depth: " + str(new_depth) + "m"
